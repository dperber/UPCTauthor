  ...
  <body id="body">
	...
	<div class="row">
		...
		<div class="col-md-3 center-block" style="margin-bottom: 25px;">	
				<?php
					if (isCompleteUnitSQL("https://server/digital-content/autordef/unidad1/index.php",$USER->id,$LINK->id)>0){
						echo '<input type="image" src="'.convertComplete("./images/unit1.png").'" width="250" alt="Demo Unit 1" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad1/index.php\''.','.'\'Demo Unit 1\''.')">';
					}else{ 
						echo '<input type="image" src="./images/unit1.png" width="250" alt="Demo Unit 1" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad1/index.php\''.','.'\'Demo Unit 1\''.')">';
					}
				?>
		</div>
		<div class="col-md-3 center-block" style="margin-bottom: 25px;">	
				<?php
					if (isCompleteUnitSQL("https://server/digital-content/autordef/evaluation1/index.php",$USER->id,$LINK->id)>0){
						echo '<input type="image" src="'.convertComplete("./images/evaluation1.png").'" width="250" alt="FinalUnit1" onclick="entrarMision('.'\'https://server/digital-content/autordef/evaluation1/index.php\''.','.'\'FinalUnit1\''.')">';
					}else{ 
						if (isOpenUnitSQL("FinalUnit1",$USER->id,$LINK->id)==1){
							echo '<input type="image" src="./images/evaluation1.png" width="250" alt="FinalUnit1" onclick="entrarMision('.'\'https://server/digital-content/autordef/evaluation1/index.php\''.','.'\'FinalUnit1\''.')">';
						}
					}
				?>
		</div>
		<div class="col-md-3 center-block" style="margin-bottom: 25px;">	
				<?php
					if (isCompleteUnitSQL("https://server/digital-content/autordef/unidad2/index.php",$USER->id,$LINK->id)>0){
						echo '<input type="image" src="'.convertComplete("./images/unit2.png").'" width="250" alt="Demo Unit 2" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad2/index.php\''.','.'\'Demo Unit 2\''.')">';
					}else{ 
						if (isOpenUnitSQL("Demo Unit 2",$USER->id,$LINK->id)==1){
							echo '<input type="image" src="./images/unit2.png" width="250" alt="Demo Unit 2" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad2/index.php\''.','.'\'Demo Unit 2\''.')">';
						}
					}
				?>
		</div>
		<div class="col-md-3 center-block" style="margin-bottom: 25px;">	
				<?php
					if (isCompleteUnitSQL("https://server/digital-content/autordef/unidad3/index.php",$USER->id,$LINK->id)>0){
						echo '<input type="image" src="'.convertComplete("./images/unit3.png").'" width="250" alt="Demo Unit 3" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad3/index.php\''.','.'\'Demo Unit 3\''.')">';
					}else{ 
						if (isOpenUnitSQL("Demo Unit 3",$USER->id,$LINK->id)==1){
							echo '<input type="image" src="./images/unit3.png" width="250" alt="Demo Unit 3" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad3/index.php\''.','.'\'Demo Unit 3\''.')">';
						}
					}
				?>
		</div>
		<div class="col-md-3 center-block" style="margin-bottom: 25px;">	
				<?php
					if (isCompleteUnitSQL("https://server/digital-content/autordef/unidad4/index.php",$USER->id,$LINK->id)>0){
						echo '<input type="image" src="'.convertComplete("./images/unit4.png").'" width="250" alt="Demo Unit 4" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad4/index.php\''.','.'\'Demo Unit 4\''.')">';
					}else{ 
						if (isOpenUnitSQL("Demo Unit 4",$USER->id,$LINK->id)==1){
							echo '<input type="image" src="./images/unit4.png" width="250" alt="Demo Unit 4" onclick="entrarMision('.'\'https://server/digital-content/autordef/unidad4/index.php\''.','.'\'Demo Unit 4\''.')">';
						}
					}
				?>
		</div>
