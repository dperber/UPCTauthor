...
public class UpctformaFactoryImpl extends EFactoryImpl implements UpctformaFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case UpctformaPackage.DEFINITION: return createDefinition();
			case UpctformaPackage.COLUMN_ELEMENT: return createColumnElement();
			case UpctformaPackage.SIMPLE: return createSimple();
			case UpctformaPackage.WIDGET_DEF: return createWidgetDef();
			...
			case UpctformaPackage.DATA_TYPE: return createDataType();
