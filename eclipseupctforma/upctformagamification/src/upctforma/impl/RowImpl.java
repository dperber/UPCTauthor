...
public class RowImpl extends CompositeImpl implements Row {
	...
	/**
	 * The cached invocation delegate for the '{@link #getArgumentType(upctforma.Simple) <em>Get Argument Type</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getArgumentType(upctforma.Simple)
	 * @generated
	 * @ordered
	 */
	protected static final EOperation.Internal.InvocationDelegate GET_ARGUMENT_TYPE_SIMPLE__EINVOCATION_DELEGATE = ((EOperation.Internal)UpctformaPackage.Literals.ROW___GET_ARGUMENT_TYPE__SIMPLE).getInvocationDelegate();
	 ...
	 * @generated
	 */
	public String getArgumentType(Simple elem) {
		try {
			return (String)GET_ARGUMENT_TYPE_SIMPLE__EINVOCATION_DELEGATE.dynamicInvoke(this, new BasicEList.UnmodifiableEList<Object>(1, new Object[]{elem}));
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case UpctformaPackage.ROW___GET_ARGUMENT_TYPE__SIMPLE:
				return getArgumentType((Simple)arguments.get(0));
