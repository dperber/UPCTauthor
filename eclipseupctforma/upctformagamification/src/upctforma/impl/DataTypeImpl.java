 ...
 * </p>
 * <ul>
 *   <li>{@link upctforma.impl.DataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeImpl extends TypeImpl implements DataType {
	...
	protected EClass eStaticClass() {
		return UpctformaPackage.Literals.DATA_TYPE;
	}
	...
	public EList<SimpleType> getType() {
		if (type == null) {
			type = new EObjectContainmentEList<SimpleType>(SimpleType.class, this, UpctformaPackage.DATA_TYPE__TYPE);
		}
		return type;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case UpctformaPackage.DATA_TYPE__TYPE:
