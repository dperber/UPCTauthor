...
public class UpctformaAdapterFactory extends AdapterFactoryImpl {
	...
	protected UpctformaSwitch<Adapter> modelSwitch =
		new UpctformaSwitch<Adapter>() {
			...
			@Override
			public Adapter caseUpctforma_ContentElement(ContentElement object) {
				return createUpctforma_ContentElementAdapter();
			}
			@Override
			public Adapter caseUpctforma_Composite(Composite object) {
				return createUpctforma_CompositeAdapter();
			}
			@Override
			public Adapter caseUpctforma_NameElement(NameElement object) {
				return createUpctforma_NameElementAdapter();
			}
			@Override
			public Adapter caseUpctforma_Argument(Argument object) {
				return createUpctforma_ArgumentAdapter();
			}
			@Override
			public Adapter caseUpctforma_SimpleElement(SimpleElement object) {
				return createUpctforma_SimpleElementAdapter();
			}
			@Override
			public Adapter caseUpctforma_CompositeArgument(CompositeArgument object) {
				return createUpctforma_CompositeArgumentAdapter();
			}
			@Override
			public Adapter caseUpctforma_Type(Type object) {
				return createUpctforma_TypeAdapter();
			}
			@Override
			public Adapter caseUpctforma_Parameter(Parameter object) {
				return createUpctforma_ParameterAdapter();
			}
			@Override
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_ContentElementAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_CompositeAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_NameElementAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_ArgumentAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_SimpleElementAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_CompositeArgumentAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_TypeAdapter() {
		return null;
	}
	 ...
	 * @generated
	 */
	public Adapter createUpctforma_ParameterAdapter() {
		return null;
	}
