...
public class UpctformaPackageImpl extends EPackageImpl implements UpctformaPackage {
	...
	public void initializePackageContents() {
		...
		widgetEClass.getESuperTypes().add(this.getArgument());
		...
		simpleElementEClass.getESuperTypes().add(this.getArgument());
		parameterEClass.getESuperTypes().add(this.getContentElement());
		...
		aggregatedTypeEClass.getESuperTypes().add(this.getType());
		...
		initEReference(getWidget_Widgetarguments(), this.getArgument(), null, "widgetarguments", null, 0, -1, Widget.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEParameter(op, this.getSimpleElement(), "elem", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getAggregatedType_Type(), this.getSimpleType(), null, "type", null, 0, -1, AggregatedType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getCompositeArgument_Arguments(), this.getSimpleElement(), null, "arguments", null, 0, -1, CompositeArgument.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getWidgetType_Parameters(), this.getParameter(), null, "parameters", null, 0, -1, WidgetType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(listTypeEClass, ListType.class, "ListType", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getListType_Listtype(), this.getSimpleType(), null, "listtype", null, 1, 1, ListType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
