 ...
 * </p>
 * <ul>
 *   <li>{@link upctforma.impl.ParagraphImpl#getText <em>Text</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends MinimalEObjectImpl.Container implements Paragraph {
	...
	protected EClass eStaticClass() {
		return UpctformaPackage.Literals.PARAGRAPH;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UpctformaPackage.PARAGRAPH__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UpctformaPackage.PARAGRAPH__TEXT:
				return getText();
		}
