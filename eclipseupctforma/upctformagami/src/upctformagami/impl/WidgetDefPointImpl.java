 ...
 *   <li>{@link upctformagami.impl.WidgetDefPointImpl#getWidgetref <em>Widgetref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WidgetDefPointImpl extends MinimalEObjectImpl.Container implements WidgetDefPoint {
	...
	public EList<WidgetType> getWidgetref() {
		if (widgetref == null) {
			widgetref = new EObjectResolvingEList<WidgetType>(WidgetType.class, this, UpctformagamiPackage.WIDGET_DEF_POINT__WIDGETREF);
		}
		return widgetref;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UpctformagamiPackage.WIDGET_DEF_POINT__UNITREF:
				return getUnitref();
			case UpctformagamiPackage.WIDGET_DEF_POINT__WIDGETREF:
				return getWidgetref();
		}
