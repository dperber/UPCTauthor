...
public interface UpctformagamiPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WIDGET_DEF_POINT__WIDGETREF = 2;
	 ...
	 * @ordered
	 */
	int WIDGET_DEF_POINT_FEATURE_COUNT = 3;
	...
	/**
	 * Returns the meta object for the reference list '{@link upctformagami.WidgetDefPoint#getWidgetref <em>Widgetref</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Widgetref</em>'.
	 * @see upctformagami.WidgetDefPoint#getWidgetref()
	 * @see #getWidgetDefPoint()
	 * @generated
	 */
	EReference getWidgetDefPoint_Widgetref();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WIDGET_DEF_POINT__WIDGETREF = eINSTANCE.getWidgetDefPoint_Widgetref();
